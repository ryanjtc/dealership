...
import { ChevronDownIcon, PhoneIcon, AdjustmentsHorizontalIcon } from '@heroicons/react/20/solid';
      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-12">
          <Popover className="relative">
            <PopoverButton className="flex items-center gap-x-1 text-sm font-semibold leading-6 text-gray-900 lg:text-white">
              Shop
              <ChevronDownIcon className="h-5 w-5 flex-none text-gray-400 lg:text-white" aria-hidden="true" />
            </PopoverButton>
          ...
          <a href="#" className="text-sm font-semibold leading-6 text-gray-900 lg:text-white">
            Financing
          </a>
          <a href="#" className="text-sm font-semibold leading-6 text-gray-900 lg:text-white">
            Meet The Team
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <a href="#" className="text-sm font-semibold leading-6 text-gray-900 lg:text-white">
            123 Main St, Ontario. <span aria-hidden="true">&rarr;</span>
          </a>
        </div>
      </nav>
